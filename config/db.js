...
const dns = require("dns"); // dns is used for resolving domain names to IP addresses, which is necessary for connecting to a MongoDB database using a connection string that includes a hostname.
